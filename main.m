...
if visualization_type=='first_last'
    points1= detectBRISKFeatures(imageArray(:,:,1));
    points2= detectBRISKFeatures(imageArray(:,:,end));
    
    [features1,valid_points1] = extractFeatures(imageArray(:,:,1),points1,'Method', 'BRISK');
    [features2,valid_points2] = extractFeatures(imageArray(:,:,end),points2,'Method', 'BRISK');
    ...
    figure;
    showMatchedFeatures(imageArray(:,:,1),imageArray(:,:,end),matchedPoints1,matchedPoints2);
end